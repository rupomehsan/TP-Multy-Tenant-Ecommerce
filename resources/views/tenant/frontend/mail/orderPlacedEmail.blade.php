                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Lato',sans-serif;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="line-height: 150%;">Dear @if ($shippingInfo && $shippingInfo->full_name)
                                                                        ...
                                                                        @else
                                                                            Customer
                                                                        @endif, Thanks for your
                                                                        order!</p>
                                                                    <p style="line-height: 150%;">&nbsp;</p>
                                                                    <p style="line-height: 150%;">We are thrilled to
                                                                        inform you that your recent order with
                                                                        @if ($generalInfo && $generalInfo->company_name)
                                                                            <strong>{{ $generalInfo->company_name }}</strong>
                                                                        @else
                                                                            us
                                                                        @endif has been
                                                                        successfully received. We want to express our
                                                                        gratitude for choosing us for your online
                                                                        shopping needs.</p>
                                                                </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Lato',sans-serif;"
                                                                align="left">
                                                                <div align="center">
                                                                    <a href="{{ env('APP_URL') }}/track/order?order_no={{ $orderInfo->order_no }}"
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <span style="line-height: 16.8px;">Track
                                                                                your order</span>
                                                                        </span>
                                                                    </a>
                                                                    {{-- <a href="{{getDomain(env('APP_URL'))}}/track/order?order_no={{ $orderInfo->order_no }}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #0056ff; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                                        ...
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:4px 0px;font-family:'Lato',sans-serif;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="line-height: 140%;">
                                                                        <span
                                                                            style="color: #f9bd0b; line-height: 19.6px;">
                                                                            <strong>
                                                                    ...
                                                                    <p style="line-height: 140%;">
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <strong><a style="color: #59a8fe;"
                                                                                    target="_self"
                                                                                    href="https://techparkit.org/">Tech
                                                                                    Park It</a>&nbsp;</strong>
                                                                        </span>
                                                                    </p>
                                                                </div>
