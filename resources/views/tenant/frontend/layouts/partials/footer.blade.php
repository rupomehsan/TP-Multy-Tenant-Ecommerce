            ...
            <div class="main__footer d-flex justify-content-between">
                <div class="footer__widget footer__widget--width col-lg-3 col-xl-3">
                    ...
                    <div class="footer__widget--inner">
                        ...
                        <div class="footer__social mt-2">
                            <!-- <h3 class="social__title text-ofwhite h4 mb-15">{{ __('home.follow_us') }}</h3> -->
                                ...
                                @if (optional($generalInfo)->facebook)
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank"
                                            ...
                                            <span class="visually-hidden">{{ __('home.facebook') }}</span>
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if (optional($generalInfo)->twitter)
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank"
                                            ...
                                            <span class="visually-hidden">{{ __('home.twitter') }}</span>
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if (optional($generalInfo)->instagram)
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank"
                                            ...
                                            <span class="visually-hidden">{{ __('home.instagram') }}</span>
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if (optional($generalInfo)->youtube)
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank"
                                            ...
                                            <span class="visually-hidden">{{ __('home.youtube') }}</span>
                                        </a>
                                    </li>
                                @endif
                            </ul>
                    ...
                    <ul class="footer__widget--menu footer__widget--inner">
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/customer/home') }}">{{ __('home.my_account') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/my/orders') }}">{{ __('home.my_orders') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/my/wishlists') }}">{{ __('home.my_wishlist') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/my/payments') }}">{{ __('home.payment_history') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/support/tickets') }}">{{ __('home.support_tickets') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/promo/coupons') }}">{{ __('home.promo_coupons') }}</a>
                        </li>
                        ...
                        @guest
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text"
                                    href="{{ route('login') }}">{{ __('home.login') }}</a>
                            </li>
                        @endguest
                ...
                <div class="footer__widget footer__widget--width">
                    ...
                    <ul class="footer__widget--menu footer__widget--inner">
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/about') }}">{{ __('home.about') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/blogs') }}">{{ __('home.blog') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/contact') }}">{{ __('home.contact') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ route('TermsAndConditions') }}">{{ __('home.terms_of_services') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/privacy/policy') }}">{{ __('home.privacy_policy') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/refund/policy') }}">{{ __('home.refund_policy') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/shipping/policy') }}">{{ __('home.shipping_policy') }}</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/faq') }}">{{ __('home.faq') }}</a>
                        </li>
                    </ul>
                </div>
                <div class="footer__widget footer__widget--width col-lg-3 col-xl-3">
                            ...
                            <form class="newsletter__subscribe--form" action="{{ url('subscribe/for/newsletter') }}"
                                ...
                                <label>
                                    <input class="newsletter__subscribe--input" name="email"
                                        placeholder="{{ __('home.email_address') }}" type="email" required />
                                </label>
                ...
                <div class="footer__bottom d-flex justify-content-center align-items-center w-auto">
                    <p class="copyright__content text-ofwhite m-0">
                        {{ optional($generalInfo)->footer_copyright_text }} | Developed by <a
                            href="https://techparkit.info/" target="_blank">Tech Park IT Ltd.</a>
                    </p>
                </div>
            @endif
        </div>
