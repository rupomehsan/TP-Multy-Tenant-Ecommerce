...
<head>
    ...
    <title>Payment Voucher - {{ $paymentVoucher->voucher_no ?? 'N/A' }}</title>
    <style>
        body {
    ...
    <div class="voucher-container">
        ...
        <div class="voucher-info">
            <div class="info-item">
                ...
                <div class="info-value">{{ $paymentVoucher->voucher_no ?? 'N/A' }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Date:</div>
                <div class="info-value">{{ $paymentVoucher->trans_date ? (is_string($paymentVoucher->trans_date) ? \Carbon\Carbon::parse($paymentVoucher->trans_date)->format('d/m/Y') : $paymentVoucher->trans_date->format('d/m/Y')) : 'N/A' }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Amount:</div>
                <div class="info-value">{{ number_format($paymentVoucher->amount ?? 0, 2) }}</div>
            </div>
        </div>
        ...
        <div class="total-section">
            <div>
                <strong>Total Amount: {{ number_format($paymentVoucher->amount ?? 0, 2) }}</strong>
            </div>
        </div>

        @if($paymentVoucher->comments)
            <div style="margin-top: 20px;">
                <strong>Remarks:</strong> {{ $paymentVoucher->comments }}
            </div>
        @endif
