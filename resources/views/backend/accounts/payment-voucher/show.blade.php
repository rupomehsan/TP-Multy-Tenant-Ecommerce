                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('payment-voucher.print', $paymentVoucher->id) }}" class="btn btn-info"
                                target="_blank">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>Date:</th>
                                        <td>{{ $paymentVoucher->trans_date ? (is_string($paymentVoucher->trans_date) ? \Carbon\Carbon::parse($paymentVoucher->trans_date)->format('d/m/Y') : $paymentVoucher->trans_date->format('d/m/Y')) : 'N/A' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Total Amount:</th>
