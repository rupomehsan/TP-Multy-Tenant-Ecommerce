        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="paymentVoucherForm" method="POST"
                            action="{{ route('payment-voucher.update', $paymentVoucher->id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="trans_date" name="trans_date"
                                            value="{{ old('trans_date', $paymentVoucher->trans_date ? $paymentVoucher->trans_date->format('Y-m-d') : date('Y-m-d')) }}"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="total_amount" name="total_amount"
                                            step="0.01" value="{{ old('total_amount', $paymentVoucher->amount) }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="remarks" name="remarks"
                                            value="{{ old('remarks', $paymentVoucher->comments) }}"
                                            ...
                                            <tbody id="lineItemsBody">
                                                @if ($paymentVoucher->accTransactionDetails->count() > 0)
                                                    @foreach ($paymentVoucher->accTransactionDetails as $detail)
                                                        <tr>
                                                            <td>
                                                                <select class="form-control general_ledger"
                                                                    name="line_items[{{ $loop->index }}][general_ledger_id]"
                                                                    required>
                                                                    <option value="">-- Choose General Ledger --
                                                                    </option>
                                                                    @foreach ($groups as $group)
                                                                        <optgroup
                                                            ...
                                                            <td>
                                                                <select class="form-control payment_by"
                                                                    name="line_items[{{ $loop->index }}][payment_by_id]"
                                                                    required>
                                                                    <option value="">-- Choose Payment By --</option>
                                                                    @foreach ($groups as $group)
                                                                        <optgroup
