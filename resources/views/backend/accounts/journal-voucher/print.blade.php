...
<head>
    ...
    <title>Journal Voucher - {{ $journalVoucher->voucher_no ?? 'N/A' }}</title>
    <style>
        body {
    ...
    <div class="voucher-container">
        ...
        <div class="voucher-info">
            <div class="info-item">
                ...
                <div class="info-value">{{ $journalVoucher->voucher_no ?? 'N/A' }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Date:</div>
                <div class="info-value">{{ $journalVoucher->trans_date ? (is_string($journalVoucher->trans_date) ? \Carbon\Carbon::parse($journalVoucher->trans_date)->format('d/m/Y') : $journalVoucher->trans_date->format('d/m/Y')) : 'N/A' }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Amount:</div>
                <div class="info-value">{{ number_format($journalVoucher->amount ?? 0, 2) }}</div>
            </div>
        </div>
        ...
        <div class="total-section">
            <div>
                <strong>Total Amount: {{ number_format($journalVoucher->amount ?? 0, 2) }}</strong>
            </div>
        </div>

        @if($journalVoucher->comments)
            <div style="margin-top: 20px;">
                <strong>Remarks:</strong> {{ $journalVoucher->comments }}
            </div>
        @endif
