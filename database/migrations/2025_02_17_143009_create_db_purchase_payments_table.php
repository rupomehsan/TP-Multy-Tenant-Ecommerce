...
class CreateDbPurchasePaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('db_purchase_payments', function (Blueprint $table) {
            $table->id();

            $table->unsignedBigInteger('count_id')->nullable();            
            $table->string('payment_code', 150)->nullable();
    ...
    {
        Schema::dropIfExists('db_purchase_payments');
    }
}
