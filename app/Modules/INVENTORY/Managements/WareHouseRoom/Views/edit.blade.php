        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('UpdateProductWarehouseRoom') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="product_warehouse_room_id" value="{{ $data->id }}">
                        <div class="row">
                            <div class="col-lg-12">
                                            ...
                                            <select id="product_warehouse_id" name="product_warehouse_id"
                                                ...
                                                @foreach ($productWarehouses as $warehouse)
                                                    <option value="{{ $warehouse->id }}"
                                                        {{ (old('product_warehouse_id') ?: $data->product_warehouse_id) == $warehouse->id ? 'selected' : '' }}>
                                                        {{ $warehouse->title }}
                                                    </option>
                                                @endforeach
                                            </select>
