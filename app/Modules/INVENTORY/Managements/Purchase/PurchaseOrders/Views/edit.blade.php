...
@section('header_css')
    ...
    <script src="{{ asset('tenant/admin/assets/js/edit_purchase_order_vue.js') }}"></script>
@endsection
        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body" id="formApp">
                    ...
                    <form action="{{ route('UpdatePurchaseProductOrder') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 mt-4">
                                ...
                                <select id="payment_status" class="form-control" data-toggle="select2" name="payment_status"
                                    required>
                                    <option value="due" {{ $data->payment_status == 'due' ? 'selected' : '' }}>Due
                                    </option>
                                    <option value="paid" {{ $data->payment_status == 'paid' ? 'selected' : '' }}>Paid
                                    </option>
                                </select>
                            </div>
                        </div>
