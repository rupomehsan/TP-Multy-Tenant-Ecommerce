...
class CreateProductPurchaseOrderProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_purchase_order_products', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('product_purchase_order_products');
    }
}
