        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('UpdatePurchaseProductCharge') }}"
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="type" name="type" class="form-control">
                                                ...
                                                <option value="percent" {{ $data->type == 'percent' ? 'selected' : '' }}>
                                                    Percentage</option>
                                                <option value="fixed" {{ $data->type == 'fixed' ? 'selected' : '' }}>Fixed
                                                </option>
                                            </select>
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('type')
