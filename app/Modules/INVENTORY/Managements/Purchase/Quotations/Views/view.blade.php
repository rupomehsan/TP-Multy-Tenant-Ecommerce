...
@section('page_heading')
    View All Purchase Product Quotations
@endsection
...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">View All Purchase Product Quotations</h4>
                    <div class="table-responsive">
                        <label id="customFilter">
                            <a href="{{ route('AddNewPurchaseProductQuotation') }}" class="btn btn-primary btn-sm"
                                style="margin-left: 5px"><b><i class="fas fa-plus"></i> Add Quotation</b></a>
                        </label>v
                        <table class="table table-bordered mb-0 data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Quotation Code</th>
                                    <th class="text-center">Reference</th>
                                    {{-- <th class="text-center">Customer Name</th> --}}
                                    {{-- <th class="text-center">Created By</th> --}}
                                    <th class="text-center">Total</th>
                                    <th class="text-center">Q. Status</th>
...
@section('footer_js')
    ...
    <script type="text/javascript">
        var table = $(".data-table").DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('ViewAllPurchaseProductQuotation') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
    ...
    <script>
        ...
        $('body').on('click', '.deleteBtn', function() {
            ...
            if (confirm("Are You sure want to delete !")) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('DeletePurchaseProductQuotation', '') }}" + '/' +
