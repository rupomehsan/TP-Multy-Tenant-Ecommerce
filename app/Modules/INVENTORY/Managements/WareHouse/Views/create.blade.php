            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="card-title mb-3">Product Warehouse</h4>
                        <a href="{{ route('ViewAllProductWarehouse') }}" class="btn btn-secondary">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>

                    <form class="needs-validation" method="POST" action="{{ route('SaveNewProductWarehouse') }}"
                        ...
                        <div class="form-group text-center pt-3">
                            <a href="{{ url('view/all/product-warehouse') }}" style="width: 130px;"
