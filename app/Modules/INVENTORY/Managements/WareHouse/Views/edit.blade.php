        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('UpdateProductWarehouse') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="product_warehouse_id" value="{{ $data->id }}">
                        <div class="row">
                            <div class="col-lg-12">
