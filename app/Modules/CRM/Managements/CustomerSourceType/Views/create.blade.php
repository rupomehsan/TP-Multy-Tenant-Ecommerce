            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="card-title mb-3">Customer Source Type</h4>
                        <a href="{{ route('ViewAllCustomerSource') }}" class="btn btn-secondary">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>

                    <form class="needs-validation" method="POST" action="{{ route('SaveNewCustomerSource') }}"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" name="title" maxlength="255"
                                                class="form-control" placeholder="Enter Customer Source Type Title Here">
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('title')
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <input type="text" id="code" name="code" maxlength="255" class="form-control" placeholder="Enter Customer Source Type Code Here" >
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('code')
                                                    <strong>{{ $message }}</strong>
                                                @enderror
                        ...
                        <div class="form-group text-center pt-3">
                            <a href="{{ route('ViewAllCustomerSource') }}" style="width: 130px;"
