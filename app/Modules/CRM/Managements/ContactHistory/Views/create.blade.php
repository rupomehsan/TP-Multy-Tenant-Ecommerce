...
@section('page_heading')
    Add a Customer Contact History
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="card-title mb-3">Customer Contact History</h4>
                        <a href="{{ route('ViewAllCustomerContactHistories') }}" class="btn btn-secondary">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>

                    <form class="needs-validation" method="POST" action="{{ route('SaveNewCustomerContactHistories') }}"
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label for="contact_history_status">Contact History Status <span
                                                    class="text-danger">*</span></label>
                                            <select id="contact_history_status" name="contact_history_status"
                                                class="form-control">
                                        ...
                                        <div class="form-group">
                                            <label for="date">Next Contact Date <span
                                                    class="text-danger">*</span></label>
