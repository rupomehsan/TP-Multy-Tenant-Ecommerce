    ...
    public static function execute(Request $request)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('action', function ($data) {
                // $btn = ' <a href="' . url('admin/order/edit') . '/' . $data->slug . '" onclick="return orderEditWarning()" title="Order Edit" class="mb-1 d-inline-block btn-sm btn-warning rounded"><i class="fas fa-edit"></i></a>';
                $btn = ' <a href="' . url('admin/order/details') . '/' . $data->slug . '" title="Order Details" class="mb-1 d-inline-block btn-sm btn-info rounded"><i class="fas fa-list-ul"></i></a>';
