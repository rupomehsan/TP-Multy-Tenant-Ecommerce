...
@section('header_css')
    ...
    <link href="{{ asset('tenant/admin/multipleImgUploadPlugin') }}/image-uploader.min.css" rel="stylesheet" type="text/css" />
                                                                            ...
                                                                            @foreach ($productVariants as $productVariant)
                                                                                <tr>
                                                                                    <td class="text-center">
                                                                                        @if ($productVariant->image)
                                                                                            <img src="{{ asset($productVariant->image) }}"
                                                                                                class="variant-image-preview" style="max-height: 80px; max-width: 80px; border: 1px solid #ddd; border-radius: 4px;">
                                                                                        @else
                                                                                        ...
                                                                                        <input type="file"
                                                                                            ...
                                                                                            style="display: inline; width: 75%;" onchange="previewVariantImage(this)">
                                                                                    </td>
                                                                                    ...
                                                                                    @if (DB::table('config_setups')->where('code', 'color')->where('status', 1)->first())
                                                                                        <td class="text-center">
                                                                                            <select
                                                                                                ...
                                                                                                data-toggle="select2"
                                                                                                data-selected="{{ $productVariant->color_id }}"
                                                                                    ...
                                                                                    @if (DB::table('config_setups')->where('code', 'measurement_unit')->where('status', 1)->first())
                                                                                        <td class="text-center">
                                                                                            <select
                                                                                                ...
                                                                                                data-toggle="select2"
                                                                                                data-selected="{{ $productVariant->unit_id }}"
                                                                                                class="form-control variant-select">
                                                                                                @php
                                                                                                    echo $units;
                                                                                                @endphp
                                                                                    ...
                                                                                    @if (DB::table('config_setups')->where('code', 'product_size')->where('status', 1)->first())
                                                                                        <td class="text-center">
                                                                                            <select
                                                                                                ...
                                                                                                data-toggle="select2"
                                                                                                data-selected="{{ $productVariant->size_id }}"
                                                                                                class="form-control variant-select">
                                                                                                @php
                                                                                                    echo $product_sizes;
                                                                                                @endphp
                                                                                    ...
                                                                                    @if (DB::table('config_setups')->where('code', 'region')->where('status', 1)->first())
                                                                                        <td class="text-center">
                                                                                            <select
                                                                                                ...
                                                                                                data-toggle="select2"
                                                                                                data-selected="{{ $productVariant->region_id }}"
                                                                                                class="form-control variant-select">
                                                                                                @php
                                                                                                    echo $regions;
                                                                                                @endphp
                                                                                    ...
                                                                                    @if (DB::table('config_setups')->where('code', 'sim')->where('status', 1)->first())
                                                                                        <td class="text-center">
                                                                                            <select
                                                                                                ...
                                                                                                data-toggle="select2"
                                                                                                data-selected="{{ $productVariant->sim_id }}"
                                                                                                class="form-control variant-select">
                                                                                                @php
                                                                                                    echo $sim;
                                                                                                @endphp
                                                                                    ...
                                                                                    @if (DB::table('config_setups')->where('code', 'storage')->where('status', 1)->first())
                                                                                        <td class="text-center">
                                                                                            <select
                                                                                                ...
                                                                                                data-toggle="select2"
                                                                                                data-selected="{{ $productVariant->storage_type_id }}"
                                                                                                class="form-control variant-select">
                                                                                                @php
                                                                                                    echo $storage_types;
                                                                                                @endphp
                                                                                    ...
                                                                                    @if (DB::table('config_setups')->where('code', 'product_warranty')->where('status', 1)->first())
                                                                                        <td class="text-center">
                                                                                            <select
                                                                                                name="product_variant_warrenty_id[]"
                                                                                                data-toggle="select2"
                                                                                                data-selected="{{ $productVariant->warrenty_id }}"
                                                                                                class="form-control variant-select">
                                                                                                @php
                                                                                    ...
                                                                                    @if (DB::table('config_setups')->where('code', 'device_condition')->where('status', 1)->first())
                                                                                        <td class="text-center">
                                                                                            <select
                                                                                                ...
                                                                                                data-toggle="select2"
                                                                                                data-selected="{{ $productVariant->device_condition_id }}"
                                                                                                class="form-control variant-select">
                                                                                                @php
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <input type="number"
                                                                                            ...
                                                                                            style="height: 34px;"
                                                                                            placeholder="0" oninput="calculateTotalStock()">
                                                                                    </td>
                                                                                    <td class="text-center">
                                                                                        <input type="number"
                                                                                            class="form-control"
                                                                        ...
                                                                        @else
                                                                            <tr>
                                                                                <td class="text-center">
                                                                                    <input type="file"
                                                                                        class="form-control variant-image-input"
                                                                                        name="product_variant_image[]" onchange="previewVariantImage(this)">
                                                                                    <img class="variant-image-preview mt-2" src="" alt="" style="display:none; max-width: 80px; max-height: 80px; border: 1px solid #ddd; border-radius: 4px;">
                                                                                </td>
...
@section('footer_js')
    ...
    <script type="text/javascript">
        ...
        // Function to preview variant image
        function previewVariantImage(input) {
            if (input.files && input.files[0]) {
                var reader = new FileReader();
                var preview = $(input).siblings('.variant-image-preview');
        ...
        // Function to calculate total stock from all variants
        function calculateTotalStock() {
            if ($('#has_variant').is(":checked")) {
                var totalStock = 0;
                $('.variant-stock-input').each(function() {
        ...
        function addAnotherVariant() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Attach event listeners to new variant row
                    $('.variant-image-input').off('change').on('change', function() {
                        previewVariantImage(this);
                    });
                    $('.variant-stock-input').off('input').on('input', function() {
                        calculateTotalStock();
                    });
                },
                error: function(data) {
        ...
        function removeRow(btndel) {
            if (typeof(btndel) == "object") {
                ...
                // Recalculate total stock after removing a variant
                calculateTotalStock();
            } else {
                return false;
            }
        ...
        $(document).ready(function() {
            // Calculate initial stock on page load if variants exist
            if ($('#has_variant').is(":checked")) {
                calculateTotalStock();
            }
            
            // Set selected values for variant select fields after select2 initialization
            setTimeout(function() {
