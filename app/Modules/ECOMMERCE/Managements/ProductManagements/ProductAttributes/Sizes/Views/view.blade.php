...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">View All Attribute</h4>
    ...
    <script type="text/javascript">
        var table = $(".data-table").DataTable({
            ...
            initComplete: function() {
                ...
                var rearrangeButton = $(
                    '<a href="{{ route('AddNewProductSize') }}" class="btn btn-success btn-sm" style="margin-left: 5px;"><b><i class="fas fa-plus"></i> Add Attribute</b></a>'
                );
    ...
    <script>
        ...
        $('body').on('click', '.deleteBtn', function() {
            ...
            if (confirm("Are You sure want to delete !")) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ url('delete/product-size') }}" + '/' + productSizeId,
