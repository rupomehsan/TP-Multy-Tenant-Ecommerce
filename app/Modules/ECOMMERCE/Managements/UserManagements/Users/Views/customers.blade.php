                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <label id="customFilter">
                            <a href="{{ url('download/customer/excel') }}" class="btn btn-sm btn-success rounded ml-3"><i
                                    class="feather-download"></i> Download As Excel</a>
                        </label>
                        ...
                        <table class="table table-bordered mb-0 data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="max-width: width: 180px;">Delete Request Submitted</th>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.data == 1) {
                            ...
                            toastr.warning("Customer Cannot be Deleted",
                                "Some Relational Data are there (Ex. Order)");
                        }
