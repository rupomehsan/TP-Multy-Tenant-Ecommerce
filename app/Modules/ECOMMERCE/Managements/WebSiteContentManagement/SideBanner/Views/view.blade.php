...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">Side Banner List</h4>
                    <div class="table-responsive">

                        <label id="customFilter">
                            <a href="{{ route('AddNewSideBanner') }}" class="btn btn-success btn-sm" id="addNewFlag"
    ...
    <script>
        ...
        $('body').on('click', '.deleteBtn', function() {
            ...
            if (confirm("Are You sure want to delete !")) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ url('delete/side-banner') }}" + '/' + slug,
