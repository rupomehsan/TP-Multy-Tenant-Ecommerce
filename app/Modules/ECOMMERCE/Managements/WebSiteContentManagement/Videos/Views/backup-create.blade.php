        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ url('save/new/outlet') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <input type="text" id="code" name="code" maxlength="255" class="form-control" placeholder="Enter Outlet Code Here" >
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('code')
                                                    <strong>{{ $message }}</strong>
                                                @enderror
                        ...
                        <div class="form-group text-center pt-3">
                            <a href="{{ url('view/all/customer-source') }}" style="width: 130px;"
