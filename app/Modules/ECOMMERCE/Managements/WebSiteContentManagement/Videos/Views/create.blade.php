        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('SaveNewVideoGallery') }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="source" name="source" class="form-control" cols="7" rows="5"
                                                placeholder="Enter Video Source(Link) Here"></textarea>
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('source')
                                                    {{ $message }}
                                                @enderror
                        ...
                        <div class="form-group text-center pt-3">
                            <a href="{{ url('view/all/video-gallery') }}" style="width: 130px;"
