        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('UpdateOutlet') }}"
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    @foreach ($images as $img)
                                                        <div class="m-2">
                                                            <img src="{{ asset(ltrim($img, '/')) }}" alt="Image"
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="opening" name="opening" maxlength="255"
                                                class="form-control" value="{{ $data->opening }}"
                                                placeholder="Enter Opening and Ending Time Here">
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('opening')
                                                    <strong>{{ $message }}</strong>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contact_number_1" name="contact_number_1"
                                                maxlength="255" class="form-control" value="{{ $data->contact_number_1 }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contact_number_2" name="contact_number_2"
                                                maxlength="255" class="form-control" value="{{ $data->contact_number_2 }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="video_link" name="video_link" class="form-control" cols="7" rows="5"
                                                placeholder="Enter Video Introduction/Description(If Available)">{{ $data->video_link }}</textarea>
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('video_link')
                                                    {{ $message }}
                                                @enderror
