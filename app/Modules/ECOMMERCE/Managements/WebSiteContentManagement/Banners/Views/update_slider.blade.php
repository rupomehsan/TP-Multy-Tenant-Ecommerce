        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('UpdateSlider') }}"
                            ...
                            <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sub_title" value="{{ $data->sub_title }}"
                                                id="sub_title" class="form-control" placeholder="Write Sub Title Here" />
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" value="{{ $data->description }}"
                                        id="description" class="form-control" placeholder="Write Description Here" />
                                </div>
