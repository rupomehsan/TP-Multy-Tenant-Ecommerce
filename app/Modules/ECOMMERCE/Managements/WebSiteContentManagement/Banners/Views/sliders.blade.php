    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <label id="customFilter">
                            <a href="{{ route('AddNewSlider') }}" class="btn btn-success btn-sm" id="addNewFlag"
                                style="margin-left: 5px"><i class="feather-plus"></i> Add New Slider</a>
                            <a href="{{ route('RearrangeSlider') }}" class="btn btn-info btn-sm" style="margin-left: 5px"><i
              ...
              save/new/slider                      <th class="text-center">Slider Link</th>
    ...
    <script>
        ...
        $('body').on('click', '.deleteBtn', function() {
            ...
            if (confirm("Are You sure want to delete !")) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('DeleteSliderBanner', ':slug') }}".replace(':slug', slug),
